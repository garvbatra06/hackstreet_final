...
const faqs = [
  {
    ...
    a: "HackStreet is open to all college students. You can participate individually or form a team of up to 4 members. Developers, designers, and innovators from all skill levels are welcome.",
  },
  {
      ...
      <style>{`
        ...
        .lantern-body {
          ...
          box-shadow:
            ...
            inset 0 0 30px rgba(120,160,255,0.05);
        }
        ...
        .lantern:hover .lantern-body {
          ...
          box-shadow:
            0 0 35px rgba(120,160,255,0.35),
            0 0 80px rgba(70,120,255,0.15);
        }
        ...
        .lantern.is-open .lantern-body {
          ...
          box-shadow:
            0 0 45px rgba(120,170,255,0.5),
            inset 0 0 60px rgba(120,170,255,0.15);
        }
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(to bottom, transparent 0%, rgba(5,8,15,0.82) 40%, rgba(5,8,15,0.82) 60%, transparent 100%)",
      ...
      {KANJI.map((k, i) => (
        <div
          ...
          style={{
            ...
            left: 0,
            color:
              i % 3 === 0 ? "rgba(192,57,43,0.75)" : "rgba(255,255,255,0.35)",
            fontSize: `${16 + (i % 3) * 8}px`,
            fontFamily: "serif",
            letterSpacing: "2px",
            animation: `kanjiFloat ${10 + i * 1.4}s ${
              i * 0.9
            }s infinite linear`,
            textShadow:
              i % 3 === 0
      ...
      <div
        style={{
          ...
          height: "1px",
          background:
            "linear-gradient(90deg, transparent, rgba(192,57,43,0.6) 30%, rgba(192,57,43,0.6) 70%, transparent)",
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        <section ref={page1Ref} className="hs-section">
          <animated.img
            ...
            style={{
              zIndex: 1,
              transform: to(
                [heroSpring.mx, heroSpring.my],
                (mx, my) => `translate(${mx * -10}px, ${my * -10}px)`
              ),
            }}
          />
          <animated.img
            ...
            style={{
              ...
              transform: to(
                [heroSpring.mx, heroSpring.my],
                (mx, my) =>
                  `translate(calc(-50% + ${mx * -18}px), ${my * -18}px)`
              ),
            }}
          />
          <animated.img
            ...
            style={{
              ...
              transform: to(
                ...
                (mx, my, s) =>
                  `translate(${mx * 20}px, calc(${my * 20}px + ${s}px))`
              ),
            }}
          />
          <animated.div
            style={{
              ...
              transform: to(
                [heroSpring.mx, heroSpring.my],
                (mx, my) => `translate(${mx * -5}px, ${my * -5}px)`
              ),
            }}
          >
            <img
              ...
              style={{
                ...
                filter:
                  "invert(100%) sepia(100%) saturate(400%) hue-rotate(180deg) brightness(200%) contrast(100%) drop-shadow(0 0 3px rgba(0,255,255,0.8)) drop-shadow(0 0 20px rgba(0,100,255,0.5))",
              }}
            />
          </animated.div>
          <div
        ...
        <section ref={page2Ref} className="hs-section">
          <animated.img
            ...
            style={{
              zIndex: 1,
              transform: spring2.shift.to((s) => `translateY(${s}px)`),
            }}
          />
          ...
          >
            ...
            >
              ...
              <br />
              <br />
              Join us for 24 hours of creativity, coding, and innovation where
          ...
          <animated.img
            ...
            style={{
              ...
              pointerEvents: "none",
              opacity: 0.9,
              transform: spring2.shift.to((s) => `translateY(${s * 1.4}px)`),
            }}
          />
        ...
        <section ref={page3Ref} className="hs-section hs-section--auto">
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(rgba(5, 6, 8, 0.7), rgba(5, 6, 8, 0.9)), url('/images/themes/bgnew.png')",
        ...
        <section ref={page4Ref} className="hs-section hs-section--auto">
          <animated.img
            ...
            style={{
              zIndex: 1,
              transform: spring4.shift.to((s) => `translateY(${s}px)`),
            }}
          />
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to bottom, transparent, rgba(212,175,55,0.05))",
              zIndex: 10,
              pointerEvents: "none",
            }}
          />
              ...
              <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-16 w-full max-w-7xl">
                ...
                <div className="w-full lg:w-3/5 flex flex-col gap-4 pb-8">
                  {[
                    {
                      rank: "WINNER",
                      desc: "The Grand Prize will be given to a project that outstands all other submissions.",
                      amount: "₹50,000",
                      color: "from-yellow-500/40",
                      textColor: "text-yellow-500",
                      glow: "0_0_25px_rgba(234,179,8,1)",
                    },
                    {
                      rank: "1ST RUNNER UP",
                      desc: "1st Runner-up prize will be given to the second best project of the hackathon.",
                      amount: "₹30,000",
                      color: "from-slate-400/30",
                      textColor: "text-slate-300",
                      glow: "0_0_25px_rgba(203,213,225,0.9)",
                    },
                    {
                      rank: "2ND RUNNER UP",
                      desc: "2nd Runner-up project of the hackathon will win some awesome prizes.",
                      amount: "₹20,000",
                      color: "from-orange-800/30",
                      textColor: "text-orange-700",
                      glow: "0_0_25px_rgba(194,65,12,0.9)",
                    },
                  ].map((prize, i) => (
                    <div
                      key={i}
                    ...
                    >
                      <div
                        className={`bg-gradient-to-r ${prize.color} to-transparent p-[2px] transition-all duration-500`}
                      >
